...
file_due = '/home/matteo/Documenti/tesi/grafici3/dif/reward_mosse_Diff_PPO_0.9_0-1.txt'
...
plt.plot(np.arange(6000),[-1.4 for i in range(6000)],label='ottimo', color='orange')



# Plotta i dati
ax.plot(tempo,yB,label='0',color='green')
...
# Plotta i dati
ax.plot(tempo,yB,label='0-1',color='yellow')
ax.set_xlabel('secondi')
ax.set_xlim(0,6000)
