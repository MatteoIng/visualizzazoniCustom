...
plt.plot(np.arange(700),[-1.4 for i in range(700)],label='ottimo', color='orange')



# Plotta i dati
ax.plot(tempo,yA,label='PG',color='green')
...
# Plotta i dati
ax.plot(tempo,yA,label='PPO',color='yellow')
ax.set_xlabel('secondi')
ax.set_xlim(0,700)
...
# Plotta i dati
ax.plot(tempo,yA,label='Impala',color='black')
ax.set_xlabel('secondi')
ax.set_xlim(0,700)
...
# Plotta i dati
ax.plot(tempo,yA,label='DQN',color='purple')
ax.set_xlabel('secondi')
ax.set_xlim(0,700)
...
# Plotta i dati
ax.plot(tempo,yA,label='Apex',color='gray')
ax.set_xlabel('secondi')
ax.set_xlim(0,700)
