...
# Plotta i dati
ax.plot(np.arange(len(yB)),yB,label='PPO',color='green')
...
# Plotta i dati
ax.plot(np.arange(len(yB)),yB,label='PG',color='yellow')
...
# Plotta i dati
ax.plot(np.arange(len(yB)),yB,label='DQN',color='black')
...
# Plotta i dati
ax.plot(np.arange(len(yB)),yB,label='Impala',color='purple')
...
# Plotta i dati
ax.plot(np.arange(len(yB)),yB,label='Apex',color='gray')
